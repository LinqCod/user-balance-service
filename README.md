# Тестовое задание на позицию стажера-бекендера в компанию Avito 2021 (Не актуально)

## Микросервис для работы с балансом пользователей.

**Примечание:**

Исходные данные можно найти здесь: https://github.com/avito-tech/autumn-2021-intern-assignment
...
4. Кеширование: Redis
5. Месседж брокер: RabbitMQ (?)
6. Контейнеризация: docker-compose
